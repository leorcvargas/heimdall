defmodule HeimdallWeb.UserAuthTest do
  use HeimdallWeb.ConnCase, async: true

  alias Heimdall.Accounts
  alias HeimdallWeb.UserAuth
  import Heimdall.AccountsFixtures

  @remember_me_cookie "_heimdall_web_user_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, HeimdallWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      HeimdallWeb.Endpoint.subscribe(live_socket_id)
